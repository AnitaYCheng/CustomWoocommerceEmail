...
if ( ! class_exists( 'WC_Custom_Email' ) ) :
...
class WC_Custom_Email extends WC_Email {
	...
	function __construct() {
		...
		$this->id             = 'custom_name';
		$this->title          = __( 'Custom Name Invoice', 'woocommerce' );
		$this->description    = __( 'Custom invoice emails can be sent to the user containing order info and payment links, with requests for more information.', 'woocommerce' );
		...
		$this->heading        = __( 'Invoice for {order_number}', 'woocommerce');
